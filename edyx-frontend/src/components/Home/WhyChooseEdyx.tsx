...
const WhyChooseEdyx: React.FC = () => {
    return (
        <section className="deep-dive-section" id="features">
            <div className="section-header">
                <h2 className="section-title">Why Choose Edyx?</h2>
                <p className="section-subtitle">Developer-first platform. Built for scale, optimized for latency.</p>
            </div>
            ...
            <div className="container">
                ...
                {/* SITUATION AWARE (Reversed) */}
                <div className="feature-row reverse">
                    <div className="feature-text">
                        <div className="icon-box" style={{ background: "linear-gradient(135deg, #f97316, #ea580c)" }}><Sparkles size={24} /></div>
                        <h2>Situation Aware.</h2>
                        <p>
                            Our <strong>SITUATION-AWARE</strong> model understands the physical and global context of your requests. Perfect for geography, real-time events, and space-time contextual understanding.
                        </p>
                        <ul className="feature-list">
                            <li>• Global Context Awareness</li>
                            <li>• Enhanced Geospatial Logic</li>
                            <li>• Adaptive Real-Time Context</li>
                        </ul>
                    </div>
                    <div className="feature-visual">
                        <div className="visual-card">
                            <div className="map-visual">
                                <svg viewBox="0 0 200 120" className="world-map-svg">
                                    {/* Abstract World Map Dots - Styled better */}
                                    <path d="M30 40h4v4h-4z M35 45h4v4h-4z M40 35h4v4h-4z M25 50h4v4h-4z M45 40h4v4h-4z M50 30h4v4h-4z M55 35h4v4h-4z M60 25h12v4h-12z M75 20h4v4h-4z M85 25h4v4h-4z M95 20h12v4h-12z M110 25h4v4h-4z M120 20h12v4h-12z M135 25h16v4h-16z M155 30h12v4h-12z M170 35h4v4h-4z M165 40h4v4h-4z M160 45h4v4h-4z M150 50h12v4h-12z M140 55h4v4h-4z M130 60h4v4h-4z M120 70h12v4h-12z M140 75h4v4h-4z M150 85h12v4h-12z M110 40h4v4h-4z M100 45h4v4h-4z M90 50h4v4h-4z M85 60h4v4h-4z M75 65h4v4h-4z M65 75h12v4h-12z M55 85h4v4h-4z M45 90h4v4h-4z M35 70h4v4h-4z M80 35h4v4h-4z M125 35h4v4h-4z" fill="#cbd5e1" opacity="0.6" />
                                    
                                    {/* Active Nodes / Hotspots */}
                                    <circle cx="45" cy="40" r="2" fill="#f97316" />
                                    <circle cx="125" cy="35" r="2" fill="#f97316" />
                                    <circle cx="150" cy="85" r="2" fill="#f97316" />
                                    <circle cx="85" cy="60" r="2" fill="#f97316" />
                                    
                                    {/* Smooth Pulsing Rings */}
                                    <motion.circle cx="45" cy="40" r="2" fill="none" stroke="#f97316" strokeWidth="1" animate={{ r: [2, 12], opacity: [1, 0] }} transition={{ duration: 2.5, repeat: Infinity, ease: "easeOut" }} />
                                    <motion.circle cx="125" cy="35" r="2" fill="none" stroke="#f97316" strokeWidth="1" animate={{ r: [2, 12], opacity: [1, 0] }} transition={{ duration: 2.5, repeat: Infinity, delay: 0.8, ease: "easeOut" }} />
                                    <motion.circle cx="150" cy="85" r="2" fill="none" stroke="#f97316" strokeWidth="1" animate={{ r: [2, 12], opacity: [1, 0] }} transition={{ duration: 2.5, repeat: Infinity, delay: 1.6, ease: "easeOut" }} />
                                    <motion.circle cx="85" cy="60" r="2" fill="none" stroke="#f97316" strokeWidth="1" animate={{ r: [2, 12], opacity: [1, 0] }} transition={{ duration: 2.5, repeat: Infinity, delay: 0.4, ease: "easeOut" }} />
                                    
                                    {/* Connection Lines (Network effect) */}
                                    <motion.path d="M45 40 Q 85 20 125 35" fill="none" stroke="#f97316" strokeWidth="0.5" strokeDasharray="2 2" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 0.5 }} transition={{ duration: 3, repeat: Infinity, repeatType: "reverse" }} />
                                    <motion.path d="M125 35 Q 140 60 150 85" fill="none" stroke="#f97316" strokeWidth="0.5" strokeDasharray="2 2" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 0.5 }} transition={{ duration: 3, repeat: Infinity, repeatType: "reverse", delay: 1 }} />
                                    <motion.path d="M45 40 Q 65 60 85 60" fill="none" stroke="#f97316" strokeWidth="0.5" strokeDasharray="2 2" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 0.5 }} transition={{ duration: 3, repeat: Infinity, repeatType: "reverse", delay: 0.5 }} />
                                    ...
                                    <motion.path
                                        d="M -50 -50 L 0 120 L -30 120 Z"
                                        fill="url(#radarGradient)"
                                        animate={{ x: [0, 300] }}
                                        transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                                    />
                                    {/* Scanning laser line at the front of the sweep */}
                                    <motion.line
                                        x1="0" y1="0" x2="0" y2="120"
                                        stroke="#f97316" strokeWidth="1.5"
                                        animate={{ x1: [0, 250], x2: [0, 250] }}
                                        transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                                    />
                                </svg>
                            </div>
        ...
        /* Map Visual */
        .map-visual { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: #fafafa; border-radius: 16px; position: relative; overflow: hidden; }
        .world-map-svg { width: 90%; height: auto; opacity: 0.8; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05)); }
